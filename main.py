...
if __name__ == '__main__':
    ...
    # optim = cangeneticAlgorithm(decisionTreeCostWholeImage,init_pop,lambda gen: gen > 10000,tournamentselect,twoPointcrossover,aedgestructureMutation)
    ...
    optim = geneticAlgorithm(decisionTreeCostWholeImage,init_pop,lambda gen: gen > 10000,tournamentselect,twoPointcrossover,aedgestructureMutation)
